...
class ReservationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin_id = \App\User::where('email','=','jamal@harvard.edu')->pluck('id');
        DB::table('reservations')->insert([
            ...
            'date_of_event' => DateTime::createFromFormat('m-j-Y', '12-24-2015'),
            'start_time' => '09:00:00',
            'end_time' => '09:30:00',
        ...
        DB::table('reservations')->insert([
            ...
            'user_group' => 'Joshua 1 Fellowship',
            'description_of_event' => $faker->text($maxNbChars = 200),
            'date_of_event' => DateTime::createFromFormat('m-j-Y', '12-24-2013'),
            'start_time' => '09:00:00',
            'end_time' => '14:30:00',
            'expected_num_of_attendees' => 10,
            'status' => 'approved',
        ...
        DB::table('reservations')->insert([
            ...
            'user_group' => 'Joshua 1 Fellowship',
            'description_of_event' => $faker->text($maxNbChars = 200),
            'date_of_event' => DateTime::createFromFormat('m-j-Y', '12-25-2015'),
            'start_time' => '09:00:00',
            'end_time' => '09:30:00',
            'expected_num_of_attendees' => 10,
            'status' => 'approved',
        ...
        DB::table('reservations')->insert([
            ...
            'room_id' => $room_id,
            'user_id' => $user_id,
            'user_group' => 'Joshua 2 Fellowship',
            'description_of_event' => $faker->text($maxNbChars = 200),
            'date_of_event' => DateTime::createFromFormat('m-j-Y', '12-25-2015'),
            'start_time' => '09:00:00',
            'end_time' => '09:30:00',
